...
```
$ docker image tag gateway andreaspeziale/gateway
$ docker push andreaspeziale/gateway
$ docker image tag invoice andreaspeziale/invoice
$ docker push andreaspeziale/invoice
$ docker image tag notification andreaspeziale/notification
$ docker push andreaspeziale/notification
```
